...
class P1637_WidestVerticalAreaBetweenTwoPointsContainingNoPoints {
    public static void main(String[] args) {
        Solution solution = new P1637_WidestVerticalAreaBetweenTwoPointsContainingNoPoints().new Solution();
