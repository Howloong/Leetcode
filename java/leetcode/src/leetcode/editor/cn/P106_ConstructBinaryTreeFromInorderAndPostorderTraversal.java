...
class P106_ConstructBinaryTreeFromInorderAndPostorderTraversal {
    ...
    class Solution {
        public TreeNode buildTree(int[] inorder, int[] postorder) {
            ...
            node.left = buildTree(Arrays.copyOfRange(inorder, 0, right), Arrays.copyOfRange(postorder, 0, right));
            node.right = buildTree(Arrays.copyOfRange(inorder, right + 1, inorder.length), Arrays.copyOfRange(postorder,
