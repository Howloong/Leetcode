...
// 
//
// Related Topics 数组 哈希表 二分查找 有序集合 前缀和 排序 👍 85 👎 0
...
//Java:花期内花的数目
//Time:2023-09-28 10:27:30
class P2251_NumberOfFlowersInFullBloom {
    public static void main(String[] args) {
        Solution solution = new P2251_NumberOfFlowersInFullBloom().new Solution();
    }
