...
//Java:检查相同字母间的距离
//Time:2023-04-09 17:21:22
class P2399_CheckDistancesBetweenSameLetters {
    public static void main(String[] args) {
        Solution solution = new P2399_CheckDistancesBetweenSameLetters().new Solution();
        ...
        public boolean checkDistances(String s, int[] distance) {
            ...
            for (int i = 0; i < s.length(); i++) {
                ...
                if (hashMap.containsKey(c)) {
                    if (i - hashMap.get(c) - 1 != distance[c - 'a']) {
                        return false;
                    }
                } else {
                    hashMap.put(c, i);
