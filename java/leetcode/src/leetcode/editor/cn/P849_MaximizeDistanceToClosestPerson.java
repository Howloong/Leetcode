...
// 
//
// Related Topics 数组 👍 240 👎 0

package leetcode.editor.cn;

//Java:到最近的人的最大距离
//Time:2023-08-22 13:16:49
class P849_MaximizeDistanceToClosestPerson {
    public static void main(String[] args) {
        Solution solution = new P849_MaximizeDistanceToClosestPerson().new Solution();
