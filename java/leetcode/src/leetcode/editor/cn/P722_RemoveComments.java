...
//Java:删除注释
//Time:2023-08-22 15:20:08
class P722_RemoveComments {
    public static void main(String[] args) {
        Solution solution = new P722_RemoveComments().new Solution();
    }
