...
//Java:消灭怪物的最大数量
//Time:2023-09-03 13:15:15
class P1921_EliminateMaximumNumberOfMonsters {
    public static void main(String[] args) {
        Solution solution = new P1921_EliminateMaximumNumberOfMonsters().new Solution();
        ...
        System.out.println(solution.eliminateMaximum(new int[]{3, 2, 4}, new int[]{5, 3, 2}));
        System.out.println(solution.eliminateMaximum(new int[]{4, 2, 3}, new int[]{2, 1, 1}));
    }
