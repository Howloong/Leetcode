...
//Java：拆分数位后四位数字的最小和
class P2160_MinimumSumOfFourDigitNumberAfterSplittingDigits {
    public static void main(String[] args) {
        Solution solution = new P2160_MinimumSumOfFourDigitNumberAfterSplittingDigits().new Solution();
