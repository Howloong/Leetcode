...
// 
//
// Related Topics 字符串 字符串匹配 👍 63 👎 0

package leetcode.editor.cn.java;

//Java:检查单词是否为句中其他单词的前缀
//Time:2022-08-21 15:56:08
class P1455_CheckIfAWordOccursAsAPrefixOfAnyWordInASentence {
    public static void main(String[] args) {
        Solution solution = new P1455_CheckIfAWordOccursAsAPrefixOfAnyWordInASentence().new Solution();
