...
// 
//
// Related Topics 广度优先搜索 字符串 👍 55 👎 0

package leetcode.editor.cn.java;

//Java:执行操作后字典序最小的字符串
//Time:2023-03-19 10:40:48
class P1625_LexicographicallySmallestStringAfterApplyingOperations {
    public static void main(String[] args) {
        Solution solution = new P1625_LexicographicallySmallestStringAfterApplyingOperations().new Solution();
//        System.out.println(solution.findLexSmallestString("5525", 9, 2));
        System.out.println(solution.findLexSmallestString("74", 5, 1));
    }
