...
// 
// Related Topics 字符串 👍 175 👎 0

package leetcode.editor.cn.java;

//Java：验证IP地址
class P468_ValidateIpAddress {
    public static void main(String[] args) {
        Solution solution = new P468_ValidateIpAddress().new Solution();
        System.out.println(solution.validIPAddress("02001:0db8:85a3:0000:0000:8a2e:0370:7334"));
        System.out.println(solution.validIPAddress("2001:db8:85a3:0::8a2E:0370:7334"));
    ...
    class Solution {
        public String validIPAddress(String queryIP) {
            if (queryIP.split(":").length != 8 || queryIP.split(".").length != 4) {
                return "Neither";
            }
            if (queryIP.matches("(((2(5[0-5]|[0-4]\\d))|(1\\d{1,2})|([1-9]{1,2})|(0))\\.){3}((2(5[0-5]|[0-4]\\d))|" +
                    "(1\\d{1,2})|([1-9]{1,2})|(0))")) {
                return "IPv4";
            } else if (queryIP.matches("(([\\da-fA-F]{1,4}\\:){7})([\\da-fA-F]{1,4})")) {
                return "IPv6";
            }
            return "Neither";
        }
