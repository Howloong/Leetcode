...
//Java:执行所有后缀指令
//Time:2022-09-17 23:50:02
class P2120_ExecutionOfAllSuffixInstructionsStayingInAGrid {
    public static void main(String[] args) {
        Solution solution = new P2120_ExecutionOfAllSuffixInstructionsStayingInAGrid().new Solution();
