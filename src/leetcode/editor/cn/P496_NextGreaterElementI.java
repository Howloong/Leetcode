...
//
// Related Topics 栈 数组 哈希表 单调栈 👍 813 👎 0
    ...
    class Solution {
        public int[] nextGreaterElement(int[] nums1, int[] nums2) {
            ...
            for (int i = 0; i < nums2.length; i++) {
                while (!arrayDeque.isEmpty() && nums2[arrayDeque.peek()] < nums2[i]) {
                    hashMap.put(nums2[arrayDeque.peek()], nums2[i]);
                    arrayDeque.pop();
                }
                arrayDeque.push(i);
            }
