...
//Java:统计数组中峰和谷的数量
//Time:2022-07-21 15:15:07
class P2210_CountHillsAndValleysInAnArray {
    public static void main(String[] args) {
        Solution solution = new P2210_CountHillsAndValleysInAnArray().new Solution();
//        System.out.println(solution.countHillValley(new int[]{2, 4, 1, 1, 6, 5}));
//        System.out.println(solution.countHillValley(new int[]{6,6,5,5,4,1}));
        System.out.println(solution.countHillValley(new int[]{8, 2, 5, 7, 7, 2, 10, 3, 6, 2}));
    }
