...
// 
// Related Topics 贪心 字符串 枚举 👍 13 👎 0

package leetcode.editor.cn;

//Java：移除指定数字得到的最大结果
class P2259_RemoveDigitFromNumberToMaximizeResult {
    public static void main(String[] args) {
        Solution solution = new P2259_RemoveDigitFromNumberToMaximizeResult().new Solution();
