...
//Java:更新数组后处理求和查询
//Time:2023-07-26 18:45:53
class P2569_HandlingSumQueriesAfterUpdate {
    ...
    class SegTree {
        ...
        public void pushdown(int x) {
            if (arr[x].lasyTag) {
                arr[2 * x].lasyTag = !arr[2 * x].lasyTag;
                arr[2 * x].sum = arr[2 * x].r - arr[2 * x].l + 1 - arr[2 * x].sum;
                arr[2 * x + 1].lasyTag = !arr[2 * x + 1].lasyTag;
