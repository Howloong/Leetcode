...
//Java:设计有序流
//Time:2022-08-16 00:35:12
class P1656_DesignAnOrderedStream {
    public static void main(String[] args) {
        OrderedStream orderedStream = new P1656_DesignAnOrderedStream().new OrderedStream(5);
    ...
    class OrderedStream {
        ...
        public List<String> insert(int idKey, String value) {
            ...
            int temp = index;
            while (temp < size && strings[temp] != null) {
                res.add(strings[temp++]);
            }
            if (!res.isEmpty())
                index = temp;
            return res;
